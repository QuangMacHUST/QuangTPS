...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="QuangTPS - A Modern Radiotherapy Treatment Planning System"
    )
    ...
    parser.add_argument(
        "--patient", type=str, help="Load patient data folder on startup"
    )
...
def show_version():
    ...
    print("An Open Source Radiotherapy Treatment Planning System")
...
def main():
    ...
    if args.patient:
        ...
        if patient_path.exists() and patient_path.is_dir():
            ...
            QMessageBox.warning(
                main_window, "Error", f"Patient folder not found: {args.patient}"
            )
