...
class ConstraintTable(QTableWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setHorizontalHeaderLabels(
            ["Cấu trúc", "Loại ràng buộc", "Giá trị", "Sử dụng"]
        )
...
class ObjectiveTable(QTableWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setHorizontalHeaderLabels(
            ["Cấu trúc", "Loại mục tiêu", "Giá trị", "Trọng số", "Sử dụng"]
        )
...
class KBPDialog(QDialog):
    ...
    recommendationApplied = pyqtSignal(
        KBPRecommendation, ObjectiveCollection, ConstraintCollection
    )
    ...
    def generate_recommendation(self):
        ...
        try:
            ...
            QMessageBox.information(
                self, "Thành công", "Đã tạo đề xuất KBP thành công!"
            )
    ...
    def display_recommendation(self):
        ...
        self.constraints_table.populate_constraints(
    ...
    def populate_info_table(self):
        ...
        confidence_avg = (
            np.mean(list(self.recommendation.confidence.values()))
            if self.recommendation.confidence
            else 0
        )
        ...
        num_constraints = sum(
            len(c) for c in self.recommendation.dose_constraints.values()
        )
    ...
    def save_recommendation(self):
        ...
        try:
            ...
            QMessageBox.information(
                self, "Thành công", f"Đã lưu đề xuất vào {file_path}"
            )
    ...
    def load_recommendation(self):
        ...
        try:
            ...
            if (
                self.recommendation.patient_id != self.patient_id
                or self.recommendation.structure_set_id != self.structure_set_id
            ):
            ...
            QMessageBox.information(
                self, "Thành công", "Đã tải đề xuất KBP thành công!"
            )
    ...
    def apply_recommendation(self):
        ...
        selected_objectives, selected_weights = (
            self.objectives_table.get_selected_objectives()
        )
